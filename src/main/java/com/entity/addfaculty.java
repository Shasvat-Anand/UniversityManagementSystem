...
public class addfaculty {
	...
	public String toString() {
		return "addfaculty [name=" + name + ", email=" + email + ", dob=" + dob + ", address=" + address + ", phone="
				+ phone + ", fname=" + fname + ", empid=" + empid + ", qualification=" + qualification + ", deprt="
				+ deprt + ", class10=" + class10 + ", class12=" + class12 + "]";
	}
